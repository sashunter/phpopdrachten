...
?>
<!--een aside element gemaakt-->
        <aside>
<!--            een div aangemaakt-->
            <div id="menu">
<!--                een koptekst niveau  2 aangemaakt-->
                <h2>Menu</h2>
<!--                een ongeordende lijst gemaakt-->
                <ul>
<!--                    een lijst item gemaakt-->
                    <li>Hoofdstuk 2
                        <ul>
                            <li>
                    ...
                    <li>
                        ...
                        <ul>
                            <li>
                                <a href="../hoofdstuk%205/opdracht5.1.php">Opdracht 5.1</a>
                            </li>
                            <li>
                                <a href="../hoofdstuk%205/opdracht5.2.php">Opdracht 5.2</a>
                            </li>
                            <li>
                                <a href="../hoofdstuk%205/opdracht5.3.php">Opdracht 5.3</a>
                            </li>
                            <li>
                                <a href="../hoofdstuk%205/opdracht5.4.php">Opdracht 5.4</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        <ul>
                            ...
                            <li>
                                <a href="../hoofdstuk%206/opdracht6.2.php">Opdracht 6.2</a>
                            </li>
                        </ul>
                    </li>
                </ul>
